/**
 * @dsh-extensions/dsh-vision-bridge browser client.
 *
 ...
 */
window.__ModuleLoader__.load({ id: "@dsh-extensions/dsh-vision-bridge", factory: (require) => {
  ...
  function VisionBridgeSettings() {
    ...
    return el("div", { style: card },
      ...
      el("label", { style: field },
        ...
        el(Input, { value: draft.model, placeholder: "gpt-4o-mini", onChange: (e) => update("model", e.target.value) })),
